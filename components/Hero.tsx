...
function Hero() {
  return (
    <section className='h-screen'>
        <div className='main-container flex flex-col lg:flex-row gap-16 lg:gap-10 h-full lg:pt-10 lg:pb-32'>
            ...
            <div className='flex flex-col gap-5 lg:gap-10 px-3 lg:pt-20 lg:pr-24 lg:w-1/2'>
